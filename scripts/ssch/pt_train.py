...
def main(
    comment: str = None,
    num_epochs: int = 300,
    model_config_yml: str = "scripts/ssch/model_config.yml",
    pt_config_json: str = "scripts/ssch/pt_config.json",
    ...
    train_dataset = raw_dataset.select(split_name="train", max_num_items=train_max_num_items)
    train_dataset.transform = SschSampleTransform(raw_dataset.max_new_len, train_max_num_samples)
    logger.info(f"{train_dataset=!r}")

    valid_dataset = raw_dataset.select(split_name="valid", max_num_items=None)
    valid_dataset.transform = SschSampleTransform(raw_dataset.max_new_len, train_max_num_samples)
